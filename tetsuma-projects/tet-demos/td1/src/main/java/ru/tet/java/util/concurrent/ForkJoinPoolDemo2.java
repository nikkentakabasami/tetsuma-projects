...
public class ForkJoinPoolDemo2 {
	...
	public static void demo1() throws Exception {
		...
		FolderProcessor system = new FolderProcessor("/home/tetsuma/work/workspaces/ri/EAMServiceUtils/target/classes", "class");
		FolderProcessor apps = new FolderProcessor("/home/tetsuma/work/workspaces/ri/EAMServiceUtils/target/test-classes", "class");
		...
		List<String> results;
		results = system.join();
		System.out.printf("classes: %d files found.\n", results.size());
		results = apps.join();
		System.out.printf("test-classes: %d files found.\n", results.size());
