...
Array.from(items, mapFn)
  создаёт массив на основе массиво-подобных объектов. 
*/
...
arr1 = [0,0,0,0,0,6,7,8,9]; !
		
/*
copyWithin(target, start, end)
  копирует часть массива от start до end в позицию target
*/
arr1.copyWithin(0,7)
...
/*
Copying methods
  методы, которые возвращают модифицированную копию массива, не затрагивая оригинал
...
/*
flat(depth=1)
  создаёт одноуровневый массив из многоуровневых.
*/
[0, 1, 2, [3, 4]].flat();
...
/*
flatMap(func)
  аналог вызова map(func).flat()
*/
[1, 2, 3, 4].flatMap((x) => [x, x*10]);

/*
arr.join([separator])
  связывает все элементы массива в строку (через запятую по умолчанию);
*/
arr1.join(';');
...
function getBriefDemoOptions() {
  return {
    ...
    selectedOption: "check_find",
    debugMode: false,
    initFunction: () => {
    },
	beforeExec: () => {
		arr1 = Array.from({ length: 10 }, (el, index) => index*10);
	},
