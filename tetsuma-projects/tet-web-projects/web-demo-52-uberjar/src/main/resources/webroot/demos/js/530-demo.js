...
str.search(regexp)
str.indexOf(val, fromInd)
str.lastIndexOf(val, fromInd)
...
Array.from(textSample.matchAll(regex), (m) => m.index);
---
//Поиск с группами
textSample = textSample4;
regex = regexSamples[0];
